...
Main processing script that extracts and ranks relevant sections from PDF documents
...
class DocumentProcessor:
    """Main class for processing documents based on persona and job requirements."""
