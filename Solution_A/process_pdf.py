# advanced_outline_extractor.py
# Robust outline extraction with body-size cluster filtering for Adobe Round 1A
...
MAX_TEXT_LEN  = 100
DELTA_SIZE    = 1.5  # minimum gap above body font
